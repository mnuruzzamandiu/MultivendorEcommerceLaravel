@extends('backend.seller.layouts.seller_master')
@section('page_title', 'Seller Profile')
@section('seller')
                                ...
                                <form action="{{ route('seller.profile.update') }}" method="POST"
                                    ...
                                    <div class="mb-4 d-sm-flex ">
                                        <div class="mb-0 me-sm-5 d-sm-flex"> <span class="avatar avatar-xxl "> <img
                                                    src="{{ !empty($sellerData->photo) ? url('uploads/seller/' . $sellerData->photo) : url('uploads/avatar.png') }}"
                                            ...
                                            <div class="ms-sm-3">
                                                <h5 class="text-dark mb-1">{{ $sellerData->name }}</h5>
                                                <p class="text-muted mb-0"> <span
                                                        class=" me-2">Email:</span><span>{{ $sellerData->email }}</span>
                                                </p>
                                                <p class="text-muted mb-0"> <span
                                                        class="">Address:</span><span>{{ $sellerData->address }}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row gy-4 mb-4">
                                        <div class="col-xl-6">
                                            ...
                                            <input type="text" class="form-control"
                                                value="{{ $sellerData->userName }}" name="userName" id="user-name"
                                                placeholder="User
                                                        Name"
                                                readonly>
                                        </div>
                                        <div class="col-xl-6">
                                            <label for="full-name" class="form-label">Shop
                                                Name</label>
                                            <input type="text" class="form-control" value="{{ $sellerData->name }}"
                                                id="full-name" placeholder="full-name" name="name">
                                        </div>
                                        <div class="col-xl-6">
                                            <label for="email" class="form-label">Email
                                            </label>
                                            <input type="email" value="{{ $sellerData->email }}" class="form-control"
                                                id="email" placeholder="Email" name="email">
                                        </div>
                                        <div class="col-xl-6">
                                            <label for="Phone" class="form-label">Phone
                                            </label>
                                            <input type="text" value="{{ $sellerData->phone }}" class="form-control"
                                                id="Phone" placeholder="Phone" name="phone">
                                        </div>
                                        <div class="col-xl-12">
                                            <label for="address" class="form-label">Address
                                            </label>
                                            <textarea class="form-control" name="address" id="address" rows="2">{{ $sellerData->address }}</textarea>
                                        </div>
                                        <div class="col-xl-6">
                                            <label for="Phone" class="form-label">Seller Join Date
                                            </label>
                                            <input type="date" value="{{ $sellerData->seller_join }}"
                                                class="form-control" id="seller_join" placeholder="Join Date"
                                                name="seller_join">
                                        </div>
                                        <div class="col-xl-12">
                                          <label for="address" class="form-label">Seller Info
                                          </label>
                                          <textarea class="form-control" name="seller_short_info" id="seller_short_info" rows="2">{{ $sellerData->seller_short_info }}</textarea>
                                      </div>
                                        <div class="">
                                            <button class="btn btn-primary btn-md" style="display: inline-block"

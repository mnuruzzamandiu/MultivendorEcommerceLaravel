                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <ul class="language-dropdown">
                                    <li>
                                        <a href="#"><img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/flag-fr.png"
                                                alt="" />Français</a>
                                    </li>
                                    <li>
                                        <a href="#"><img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/flag-dt.png"
                                                alt="" />Deutsch</a>
                                    </li>
                                    <li>
                                        <a href="#"><img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/flag-ru.png"
                                                alt="" />Pусский</a>
                                    </li>
                                </ul>
                            </li>
        ...
        <div class="container">
            <div class="header-wrap">
                <div class="logo logo-width-1">
                    <a href="index.html"><img src="{{ asset('contents/frontend') }}/assets/imgs/theme/logo.svg"
                            alt="logo" /></a>
                </div>
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a href="shop-wishlist.html">
                                    <img class="svgInject" alt="Nest"
                                        src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-heart.svg" />
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="shop-cart.html">
                                    <img alt="Nest"
                                        src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-cart.svg" />
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Nest"
                                                        src="{{ asset('contents/frontend') }}/assets/imgs/shop/thumbnail-3.jpg" /></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Nest"
                                                        src="{{ asset('contents/frontend') }}/assets/imgs/shop/thumbnail-2.jpg" /></a>
                                            </div>
                                            <div class="shopping-cart-title">
                            ...
                            <div class="header-action-icon-2">
                                <a href="page-account.html">
                                    <img class="svgInject" alt="Nest"
                                        src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-user.svg" />
                                </a>
                                @auth
        ...
        <div class="container">
            <div class="header-wrap header-space-between position-relative">
                                ...
                                <ul>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-1.svg"
                                                alt="" />Milks and Dairies</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-2.svg"
                                                alt="" />Clothing & beauty</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-3.svg"
                                                alt="" />Pet Foods & Toy</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-4.svg"
                                                alt="" />Baking material</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-5.svg"
                                                alt="" />Fresh Fruit</a>
                                    </li>
                                </ul>
                                <ul class="end">
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-6.svg"
                                                alt="" />Wines & Drinks</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-7.svg"
                                                alt="" />Fresh Seafood</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-8.svg"
                                                alt="" />Fast food</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-9.svg"
                                                alt="" />Vegetables</a>
                                    </li>
                                    <li>
                                        <a href="shop-grid-right.html"> <img
                                                src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/category-10.svg"
                            ...
                            <div class="more_slide_open" style="display: none">
                                <div class="d-flex categori-dropdown-inner">
                                    <ul>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-1.svg"
                                                    alt="" />Milks and Dairies</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-2.svg"
                                                    alt="" />Clothing & beauty</a>
                                        </li>
                                    </ul>
                                    <ul class="end">
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-3.svg"
                                                    alt="" />Wines & Drinks</a>
                                        </li>
                                        <li>
                                            <a href="shop-grid-right.html"> <img
                                                    src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-4.svg"
                                                    alt="" />Fresh Seafood</a>
                                        </li>
                                    </ul>
                                </div>
                                        ...
                                        <li class="sub-mega-menu sub-mega-menu-width-34">
                                            <div class="menu-banner-wrap">
                                                <a href="shop-product-right.html"><img
                                                        src="{{ asset('contents/frontend') }}/assets/imgs/banner/banner-menu.png"
                                                        alt="Nest" /></a>
                ...
                <div class="hotline d-none d-lg-flex">
                    <img src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-headphone.svg"
                        alt="hotline" />
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Nest"
                                                    src="{{ asset('contents/frontend') }}/assets/imgs/shop/thumbnail-4.jpg" /></a>
                                        </div>
                                        <div class="shopping-cart-title">
    ...
    <div class="mobile-header-wrapper-inner">
        ...
        <div class="mobile-header-content-area">
            ...
            <div class="mobile-social-icon mb-50">
                ...
                <a href="#"><img
                        src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-facebook-white.svg"
                        alt="" /></a>
                <a href="#"><img
                        src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-twitter-white.svg"
                        alt="" /></a>
                <a href="#"><img
                        src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-instagram-white.svg"
                        alt="" /></a>
                <a href="#"><img
                        src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-pinterest-white.svg"
                        alt="" /></a>
                <a href="#"><img
                        src="{{ asset('contents/frontend') }}/assets/imgs/theme/icons/icon-youtube-white.svg"
                        alt="" /></a>
            </div>

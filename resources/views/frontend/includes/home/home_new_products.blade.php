                                    ...
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-1-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-1-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-2-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-2-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-3-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-3-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-4-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-4-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-5-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-5-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-6-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-6-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-7-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-7-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".3s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-8-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-8-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-9-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-9-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn" data-wow-delay=".5s">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-10-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-10-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-12-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-12-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-13-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-13-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-14-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-14-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-15-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-15-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-16-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-16-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="shop-product-right.html">
                                            <img class="default-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-11-1.jpg"
                                                alt="" />
                                            <img class="hover-img"
                                                src="{{ asset('contents/frontend') }}/assets/imgs/shop/product-11-2.jpg"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
